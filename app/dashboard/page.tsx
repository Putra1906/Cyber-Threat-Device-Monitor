...
export default function Dashboard() {
  ...
  const fetchDevices = useCallback(
    async (keyword: string = "") => {
      ...
      try {
        const url = keyword
          ? `/api/devices?q=${encodeURIComponent(keyword)}`
          : "/api/devices";
  ...
  const handleFileImport = async (
    ...
    try {
      ...
      if (response.ok && result.success) {
        toast.success(
          `Berhasil mengimpor ${result.importedCount} perangkat baru!`,
          { id: toastId }
        );
        await fetchDevices();
      } else {
  ...
  const stats = {
    ...
    maintenance: devices.filter((d) => d.status.toLowerCase() === "maintenance")
      .length,
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-gray-800">Telkomsel</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Monitor dan kelola perangkat jaringan di seluruh infrastruktur Anda
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            >
              <input
                ...
                className="w-full sm:max-w-xs pl-4 pr-3 py-2 border rounded-lg focus:ring-red-500 focus:border-red-500"
              />
              <button
                type="submit"
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 disabled:bg-blue-300"
              >
                {isImporting ? (
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {devices.map((device) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {new Date(device.detected_at).toLocaleString("id-ID", {
                        dateStyle: "short",
                        timeStyle: "medium",
                      })}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-4 items-center">
                        <button
                          onClick={() =>
                            router.push(`/dashboard/edit/${device.id}`)
                          }
